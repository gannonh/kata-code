...
const RESTRICTED_IMPORT_PATHS = [
  {
    name: "@kata-sh/code-client-runtime",
    message:
      "Import from an explicit @kata-sh/code-client-runtime/* subpath. The package has no root export.",
  },
  {
...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-kata-code/index.ts", "@shadcn/lint"],
    settings: {
    ...
    overrides: [
      ...
      },
      {
        ...
        rules: { "kata-code/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
      ...
      },
      {
        ...
        rules: { "kata-code/no-hermes-unsupported-apis": "error" },
      },
      {
        ...
        rules: {
          "kata-code/no-mobile-uniwind-theme-escape-hatches": [
            "error",
