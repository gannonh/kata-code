...
const WSL_FORWARDED_ENV_NAMES = [
  ...
  // server prefers an OTEL endpoint over the bootstrap envelope, so the Kata Code URLs
  // travel as variables to keep winning inside the distro as they do on Windows.
  "KATACODE_OTLP_TRACES_URL",
  "KATACODE_OTLP_METRICS_URL",
  "KATACODE_OTLP_LOGS_URL",
