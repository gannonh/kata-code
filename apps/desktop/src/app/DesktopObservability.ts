import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@kata-sh/code-contracts";
import {
  makeLocalFileTracer,
  makeTraceSink,
...
} from "@kata-sh/code-shared/serverSettings";
...
>()("@kata-sh/code-desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
