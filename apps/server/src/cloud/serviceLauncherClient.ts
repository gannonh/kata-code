import type { ServerSelfUpdateOutcome } from "@kata-sh/code-contracts";
...
export class ServiceLauncherVersionMismatchError extends Schema.TaggedError<ServiceLauncherVersionMismatchError>()(
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "@kata-sh/code-cli/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("@kata-sh/code-cli/cloud/serviceLauncherClient") {}
