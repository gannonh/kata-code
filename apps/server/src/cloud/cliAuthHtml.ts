...
<html lang="en">
  <head>
    ...
    <title>Kata Code Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Kata Code Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
