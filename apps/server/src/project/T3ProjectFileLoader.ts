...
import { T3_PROJECT_FILE_NAME, type T3ProjectFile } from "@kata-sh/code-contracts";
import { T3ProjectFileFromJson } from "@kata-sh/code-shared/t3ProjectFile";
...
>()("@kata-sh/code-cli/project/T3ProjectFileLoader") {}
