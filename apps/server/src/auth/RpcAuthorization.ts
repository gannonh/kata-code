...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.routinesGet]: AuthOrchestrationReadScope,
  [WS_METHODS.routinesSave]: AuthOrchestrationOperateScope,
  [WS_METHODS.routinesChange]: AuthOrchestrationOperateScope,
  [WS_METHODS.routinesTest]: AuthOrchestrationOperateScope,
  [WS_METHODS.routinesHistory]: AuthOrchestrationReadScope,
  [WS_METHODS.routinesPreview]: AuthOrchestrationReadScope,
  [WS_METHODS.routinesSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.routinesDraft]: AuthOrchestrationOperateScope,
  [WS_METHODS.routinesConnectionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.routinesConnectionsBeginAuthorization]: AuthOrchestrationOperateScope,
  [WS_METHODS.routinesConnectionsCreate]: AuthOrchestrationOperateScope,
