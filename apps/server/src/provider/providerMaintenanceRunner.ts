                ...
                makeUpdateState({
                  ...
                  message:
                    targetVersion !== undefined
                      ...
                      : "The latest provider version is incompatible with this Kata Code release. Review provider settings.",
                }),
              );
            }
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Kata Code could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Kata Code still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
