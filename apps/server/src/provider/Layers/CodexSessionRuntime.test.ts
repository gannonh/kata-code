...
describe("buildTurnStartParams", () => {
  ...
  effectIt.effect("enables localhost network for Task CLI protocol sessions only", () =>
    Effect.gen(function* () {
      const standard = yield* buildTurnStartParams({
      ...
      const taskCli = yield* buildTurnStartParams({
