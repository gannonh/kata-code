 ...
 */
import type { ProviderConsumeResetCreditOutcome } from "@kata-sh/code-contracts";
...
>()("@kata-sh/code-cli/provider/Layers/codexResetCredit/CodexResetCreditCoordinator") {}
