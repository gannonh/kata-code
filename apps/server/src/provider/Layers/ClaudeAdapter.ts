...
} from "@kata-sh/code-shared/claudeCompaction";
import { HostProcessIsExecutable } from "@kata-sh/code-shared/hostProcess";
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @kata-sh/code-shared/claudeCompaction because
