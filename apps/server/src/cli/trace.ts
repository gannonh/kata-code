/**
 * `katacode trace summary` - per-span counts, rates, and latency percentiles from
 ...
 */
import { PositiveInt } from "@kata-sh/code-contracts";
...
const traceSummaryCommand = Command.make("summary", {
  ...
  Command.withHandler(
    Effect.fn("cli.trace.summary")(function* (flags) {
      ...
      // KATACODE_TRACE_FILE, else the userdata trace file for --base-dir or
      // KATACODE_HOME. Implicit dev runs write elsewhere; set KATACODE_TRACE_FILE.
