 ...
 */
import { type RemoteOpenTarget } from "@kata-sh/code-contracts";
import { HostProcessHostname } from "@kata-sh/code-shared/hostProcess";
...
>()("@kata-sh/code-cli/environment/RemoteOpenTargets") {}
