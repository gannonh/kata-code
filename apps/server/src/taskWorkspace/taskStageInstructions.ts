...
export function trustedImplementationInstructions(): string {
  return [
    ...
    "After every phase, work item, approved check, checkpoint, and amendment gate is complete, call task_implementation_complete exactly once with the exact clean HEAD and concise summary, then stop using tools and return the final response. Do not call task_stage_complete for the Implement stage.",
