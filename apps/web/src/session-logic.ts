...
} from "@kata-sh/code-client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload } from "@kata-sh/code-contracts";
import { foldUserInputActivities } from "@kata-sh/code-client-runtime/work-log/user-input";
import * as Option from "effect/Option";
import * as Schema from "effect/Schema";
import * as Arr from "effect/Array";
import { shallow } from "zustand/vanilla/shallow";
import { isBackgroundTaskActivity } from "@kata-sh/code-client-runtime/state/subagentRuntime";
import {
...
import { extractToolActivityPresentation } from "@kata-sh/code-client-runtime/work-log/tool-presentation";
import {
...
export { formatDuration } from "@kata-sh/code-shared/orchestrationTiming";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@kata-sh/code-contracts").ToolActivitySurface;
  toolIcon?: import("@kata-sh/code-contracts").ToolActivityIcon;
  toolSource?: import("@kata-sh/code-contracts").ToolActivitySource;
  toolData?: unknown;
