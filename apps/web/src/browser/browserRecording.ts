import { DESKTOP_PREVIEW_RECORDING_CAPTURE_TRIGGER } from "@kata-sh/code-contracts";
import type { DesktopPreviewRecordingArtifact, ScopedThreadRef } from "@kata-sh/code-contracts";
