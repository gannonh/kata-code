import { scopeProjectRef, scopedThreadKey } from "@kata-sh/code-client-runtime/environment";
import {
...
import { canSnooze, effectiveSnoozed } from "@kata-sh/code-client-runtime/state/thread-settled";
