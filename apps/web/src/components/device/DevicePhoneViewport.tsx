...
import type { PhoneViewer } from "@kata-sh/code-client-runtime/device/phone-viewer";
import type {
  DeviceAccessorySource,
  DeviceModelSource,
} from "@kata-sh/code-client-runtime/device/model";
import type { DeviceShapeProfile } from "@kata-sh/code-client-runtime/device/shape-profile";
...
const loadPhoneViewer = () => import("@kata-sh/code-client-runtime/device/phone-viewer");
