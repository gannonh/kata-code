...
import type { DuoViewer } from "@kata-sh/code-client-runtime/device/duo-viewer";
import type { DeviceModelSource } from "@kata-sh/code-client-runtime/device/model";
import { createPhoneInteraction } from "@kata-sh/code-client-runtime/device/phone-interaction";
import { createCanvasFrameSink } from "@kata-sh/code-client-runtime/device/frame";
import type {
  DeviceScreenSize,
  DeviceStreamClient,
} from "@kata-sh/code-client-runtime/device/stream";
import { createDuoPinch } from "@kata-sh/code-client-runtime/device/duo-control";
import { bindPhoneTrackpad } from "./phoneTrackpad";

const loadDuoViewer = () => import("@kata-sh/code-client-runtime/device/duo-viewer");
