import { filePreviewDelimiter } from "@kata-sh/code-shared/delimitedPreview";
...
import { readFilePreviewResponse } from "@kata-sh/code-client-runtime/file-preview";
import { filePreviewKind, FILE_TEXT_PREVIEW_MAX_BYTES } from "@kata-sh/code-shared/filePreview";
import {
  CheckIcon,
  ChevronRightIcon,
  Code2,
