...
import { DEFAULT_CLIENT_SETTINGS, type DesktopSnapShotState } from "@kata-sh/code-contracts";
...
it("hides macOS setup only while permissions and the shortcut are all in place", () => {
  ...
  const revoked = {
    ...
    message: "Allow Accessibility in System Settings, then restart Kata Code.",
  };
