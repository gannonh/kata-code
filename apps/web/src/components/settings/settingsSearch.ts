...
import { STATIC_KEYBINDING_COMMANDS, type KeybindingCommand } from "@kata-sh/code-contracts";
...
import { DEFAULT_KEYBINDINGS } from "@kata-sh/code-shared/keybindings";
