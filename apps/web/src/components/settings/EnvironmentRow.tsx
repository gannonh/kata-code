import type { DesktopSshEnvironmentTarget, EnvironmentMachineKind } from "@kata-sh/code-contracts";
 ...
 * Kata Code Connect, SSH, WSL, and plain remote links are told apart without a legend.
 */
export function environmentTransportLabel(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "Kata Code Connect";
