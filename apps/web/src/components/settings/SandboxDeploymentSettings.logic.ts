...
export function readSandboxGitHubSource(config: unknown): SandboxGitHubSourceSelection | null {
...
export function setSandboxGitHubSource(
  config: unknown,
...
export function sandboxGitHubSourceRepositoryKey(repository: string): string {
