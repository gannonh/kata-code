...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@kata-sh/code-contracts";
...
/**
 * Post-sign-in onboarding wizard for Kata Code Connect. Opens on every in-session
 ...
 * account's Kata Code Connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "Kata Code Connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up Kata Code Connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through Kata Code Connect."
