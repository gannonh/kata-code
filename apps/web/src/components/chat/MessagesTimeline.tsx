...
import {
  ...
  hasQuestionAnswer,
} from "@kata-sh/code-client-runtime/work-log/user-input";
import {
...
import { parseScopedThreadKey } from "@kata-sh/code-client-runtime/environment";
import { replaceComposerContextReferences } from "@kata-sh/code-shared/composerContextReferences";
...
} from "@kata-sh/code-client-runtime/work-log/presentation";
...
import { resolveChatListAnchoredEndSpace } from "@kata-sh/code-shared/chatList";
import { toolActivityFaviconUrl } from "@kata-sh/code-shared/favicon";
import { formatDuration } from "@kata-sh/code-shared/orchestrationTiming";
import { getProjectFaviconCacheKey } from "@kata-sh/code-shared/projectFavicon";
...
} from "@kata-sh/code-shared/composerContextClipboard";
  ...
  return (
    <>
      <div className="relative min-w-0 px-1 py-0.5">
        <MessageAuthorHeading>Kata Code</MessageAuthorHeading>
        <AssistantCitationSource
          messageId={row.message.id}
...
function QuestionAnswerHistory({
  ...
  answer: import("@kata-sh/code-contracts").UserInputAttachmentAnswerPayload;
}) {
  const { activeThreadEnvironmentId } = use(TimelineRowCtx);
