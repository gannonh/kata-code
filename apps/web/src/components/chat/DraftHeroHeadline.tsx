...
import { resolveEnvironmentMachineKind, type ScopedProjectRef } from "@kata-sh/code-contracts";
import { scopedProjectKey, scopeProjectRef } from "@kata-sh/code-client-runtime/environment";
