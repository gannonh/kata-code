import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@kata-sh/code-contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/kata-code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/kata-code"
      />,
    );

    expect(markup).toContain("kata-code/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/kata-code/apps/web/src/session-logic.ts");
  });
