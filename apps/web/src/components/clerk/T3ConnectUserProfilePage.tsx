          ...
          <div className="pt-3">
            ...
            >
              ...
              <p className="mt-4 max-w-xl text-[0.8125rem] leading-[1.125rem] text-muted-foreground">
                Kata Code Connect access will be revoked, any managed tunnel will be removed, and a
  ...
  const handleDeregister = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      ...
      toastManager.add({
        ...
        description: "Kata Code Connect access was revoked and a host space is now available.",
      });
      return;
    }
        ...
        {isInitialLoad ? (
          ...
          <div className="border-t">
            <Empty size="compact">
              ...
              <EmptyHeader>
                <EmptyTitle>No Kata Code Connect environments</EmptyTitle>
                <EmptyDescription>
                  Link an environment from its local Settings to make it available through Kata Code
                  Connect.
                </EmptyDescription>
              </EmptyHeader>
            </Empty>
