...
function HistoricalBanner({
  ...
  return (
    <div
      ...
      className="flex flex-wrap items-center gap-x-2 gap-y-1 border-b border-info/25 bg-info/8 px-4 py-2.5 text-xs"
    >
...
export function TaskStageCanvas({
  ...
  return (
    ...
    >
      ...
      {/* Once the panel is docked the canvas can be narrow. The stage identity
          claims a readable minimum and the controls wrap to their own line as a
          group, rather than every control being crushed together. */}
