import { EnvironmentId, type ThreadPullRequestLink } from "@kata-sh/code-contracts";
import type { DesktopPreviewFavicon, PreviewSessionSnapshot } from "@kata-sh/code-contracts";
