...
config.resolver = {
  ...
  extraNodeModules: {
    ...
    "@kata-sh/code-mobile-third-party-licenses": generatedLicenseModuleRoot,
    "@kata-sh/code-mobile-device-stream": generatedDeviceStreamRoot,
...
async function generateMobileThirdPartyLicenses() {
  ...
  const manifest = await generateThirdPartyLicenseManifest({
    ...
    allowMissingGeneratedNotices:
      ...
      process.env.KATACODE_LICENSES_STRICT !== "1",
  });
