...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Kata Code Connect" section title when the host provides its own header.
   */
...
/**
 * A saved Kata Code Connect environment. The switch turns it on or off; off keeps the
