...
import { EnvironmentId, type ProjectReadFileResult, ThreadId } from "@kata-sh/code-contracts";
import { videoMimeType } from "@kata-sh/code-shared/video";
import {
  isWorkspaceBrowserPreviewPath,
  isWorkspaceImagePreviewPath,
  mediaMimeTypeFromExtension,
} from "@kata-sh/code-shared/filePreview";
import { mediaFileReference } from "@kata-sh/code-client-runtime/media-reference";
