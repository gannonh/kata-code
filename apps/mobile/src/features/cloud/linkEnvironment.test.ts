...
import { DPOP_UNKNOWN_HINT, ManagedRelay } from "@kata-sh/code-client-runtime/relay";
import { remoteHttpClientLayer } from "@kata-sh/code-client-runtime/rpc";
      ...
      Effect.gen(function* () {
        vi.stubGlobal(
          ...
          vi.fn((url: string | URL) => {
            ...
            if (value.endsWith("/.well-known/kata/environment")) {
              return Promise.resolve(
                Response.json({
                  environmentId: "env-1",
                  label: "Desktop",
