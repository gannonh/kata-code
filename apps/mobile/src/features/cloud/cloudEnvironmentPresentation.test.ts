import { EnvironmentId, ORCHESTRATION_PROTOCOL_VERSION } from "@kata-sh/code-contracts";
import type { RelayEnvironmentStatusResponse } from "@kata-sh/code-contracts/relay";
