...
import { reportAtomCommandResult, settlePromise } from "@kata-sh/code-client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for Kata Code Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's Kata Code Connect environments right after sign-in so every
