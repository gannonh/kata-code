...
function confirmDeregister(environment: RelayClientEnvironmentRecord, onConfirm: () => void) {
  ...
  const message = `“${environment.label}” will be removed from this account. Kata Code Connect access will be revoked, any managed tunnel will be removed, and a host space will become available. Local connections on your devices are not changed.`;
...
/**
 * The Kata Code Connect custom page inside Clerk's native user profile: every
  ...
  return (
    ...
    >
      ...
      {environmentsState.error ? (
        <>
          <ClerkRow
            title="Could not load Kata Code Connect environments"
        ...
        <ClerkRow
          ...
          subtitle="Link a server from its local Settings to reach it through Kata Code Connect."
        />
      )}
