...
import { deriveProjectGroupLabel } from "@kata-sh/code-client-runtime/state/project-grouping";
  ...
  return (
    <>
      ...
      <SettingsSection title="App">
        ...
        <SettingsRow icon="info.circle" label="About Kata Code" target="SettingsAbout" />
      </SettingsSection>
    </>
  );
}
