...
import { renderAssistantCitationsAsText } from "@kata-sh/code-shared/assistantCitations";
import { encodeComposerContextFragment } from "@kata-sh/code-shared/composerContextClipboard";
import {
  parseComposerContextHref,
  collectComposerContextReferences,
  replaceComposerContextReferences,
} from "@kata-sh/code-shared/composerContextReferences";
...
} from "@kata-sh/code-client-runtime/codex-artifact-templates";
import { resolveAssetUrl } from "@kata-sh/code-client-runtime/state/assets";
import { formatAttachmentSize } from "@kata-sh/code-client-runtime/state/attachments";
...
import { resolveViewedImageAsset } from "@kata-sh/code-client-runtime/work-log/presentation";
import {
  renderCodexFileCitationsAsMarkdown,
  splitCodexArtifactTemplateMarkdown,
} from "@kata-sh/code-client-runtime/codex-markdown-directives";
import {
  CHAT_LIST_ANCHOR_OFFSET,
  resolveChatListAnchoredEndSpace,
} from "@kata-sh/code-shared/chatList";
import { imageMimeType } from "@kata-sh/code-shared/image";
import { videoMimeType } from "@kata-sh/code-shared/video";
...
import { faviconUrlForOrigin } from "@kata-sh/code-shared/favicon";
import {
...
import { markdownFileIconSource } from "@kata-sh/code-mobile-markdown-text/file-icons";
import { PierreEntryIcon } from "../../components/PierreEntryIcon";
import { markdownLinkIconSource } from "@kata-sh/code-mobile-markdown-text/link-icons";
import {
  normalizeNativeMarkdownUrl,
  resolveMarkdownInlineCodePresentation,
  resolveMarkdownLinkIcon,
  resolveMarkdownLinkPresentation,
} from "@kata-sh/code-mobile-markdown-text/links";
import {
