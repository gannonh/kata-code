...
import type { EnvironmentId, ToolActivityIcon } from "@kata-sh/code-contracts";
import { toolActivityFaviconUrl } from "@kata-sh/code-shared/favicon";

import { AppText as Text } from "../../components/AppText";
import { KataMark } from "../../components/KataMark";
...
function WorkLogIcon(props: {
  ...
  if (props.icon === "t3-code") {
    return <KataMark size={14} borderRadius={4} />;
  }
  return (
    <SymbolView
      name={
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly themeAppearance: "light" | "dark";
  readonly toolSurface?: import("@kata-sh/code-contracts").ToolActivitySurface;
  readonly toolIcon?: ToolActivityIcon;
