...
function SubscriptionUsage(
  ...
  const providers = props.providers ?? [
    { name: "Codex", detail: "Open Kata Code to connect", windows: [], expiresAt: 0 },
    { name: "Claude", detail: "Open Kata Code to connect", windows: [], expiresAt: 0 },
  ];
