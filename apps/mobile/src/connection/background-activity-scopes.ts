import type { EnvironmentRpcSubscriptionObservation } from "@kata-sh/code-client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@kata-sh/code-contracts";
