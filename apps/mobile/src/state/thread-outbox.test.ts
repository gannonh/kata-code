...
import { EnvironmentNotRegisteredError } from "@kata-sh/code-client-runtime/connection";
import { isTransportConnectionErrorMessage } from "@kata-sh/code-client-runtime/errors";
import { EnvironmentRpcUnavailableError } from "@kata-sh/code-client-runtime/rpc";
import {
  CommandId,
