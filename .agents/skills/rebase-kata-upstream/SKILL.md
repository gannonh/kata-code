...
- Fetch main after merging and verify the actual merge SHA, pin, retained changes, and required post-merge checks. Record acceptance on Linear. A queued merge, automatic parent closure, or green portable CI does not complete an integration.
