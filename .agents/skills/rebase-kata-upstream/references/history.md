...
These observations were checked against Kata main `0c2aa608219f35ae1254092fa81a25ff26aac6d3` on September 10, 2026. The last-integration record was checked against `origin/main` `de856ab03b5eef535b40338612fc281a7e710307` on September 22, 2026. The workflow-reference lesson was checked against squash `e96c74aa48e7ae5b56b70db9b7a62096dc0df0d5` on September 15, 2026. Resolve current paths and issue states before applying them. Repository documents are the detailed evidence; this file preserves lessons that change integration decisions.

## Last upstream integration

[KAT-3432 / PR #247](https://github.com/gannonh/kata-code/pull/247) integrated 40 upstream commits, from `c14f6015bfe479d313355cb234af1a5c16dbb15f` to `b379b5b1407b4c718095cd13395173b6cc005218`, frozen on 2026-09-21. Kata base was `af0d264336d2707cd98bdd57a59feca652e24033`. The run recovered `c14f6015bfe479d313355cb234af1a5c16dbb15f` with `git merge --strategy=ours --no-ff` as `14a398ab16dac89400f4b22e9e2db32e8aacac06` before the three-way merge, and candidate `2f6e44db58314f0e2d028dee1b9f6b45e62701ac` had the Kata base, previous pin, frozen tip, and original root as ancestors. It landed as squash `cc725adf0cef8a772d0b11cdfd02579c6462b8ea` with parent `38df7f18800701a604641f73612c21e262330bad` on 2026-09-21, which discarded that ancestry. On `origin/main`, `git merge-base --is-ancestor b379b5b1407b4c718095cd13395173b6cc005218 HEAD` is false. Original root remains `6a687ee43bf222672ab8d3f4c0bab3d8d174f79f`.

Read `docs/upstream/kat-3432-intake.md` and `docs/upstream/kat-3432-decisions.tsv`.

`FORK.md` at the current Kata base is the live pin source. Recover that pin when it lacks ancestry, so the next intake recovers `b379b5b1407b4c718095cd13395173b6cc005218` while it is still absent. Do not retarget recovery at `47ace94962a714a561d7cfbdbaa4c721ef6b0598`, at `c14f6015bfe479d313355cb234af1a5c16dbb15f`, or at any pin `FORK.md` already lists as previous.

The previous integration [KAT-3411 / PR #239](https://github.com/gannonh/kata-code/pull/239) integrated 248 upstream commits, from `47ace94962a714a561d7cfbdbaa4c721ef6b0598` to `c14f6015bfe479d313355cb234af1a5c16dbb15f`. The run first froze `0150c6a53b409ba3bcb45645709b649cf8708354` and refroze to `c14f6015bfe479d313355cb234af1a5c16dbb15f` on 2026-09-20. Kata base was `13d48b9a61985ce8d197fa1baa6a5bfe79b83190`. It recovered `47ace94962a714a561d7cfbdbaa4c721ef6b0598` with `git merge --strategy=ours --no-ff`, the same class as [KAT-3297 / PR #194](https://github.com/gannonh/kata-code/pull/194), then landed as squash `8b5a83d06198cb4dfec5da735217c09310c00796` with parent `13d48b9a61985ce8d197fa1baa6a5bfe79b83190`, so `c14f6015bfe479d313355cb234af1a5c16dbb15f` is not an ancestor of `origin/main` either. Read `docs/upstream/kat-3411-intake.md` and `docs/upstream/kat-3411-decisions.tsv`.

Before that, [KAT-3371 / PR #223](https://github.com/gannonh/kata-code/pull/223) integrated 107 upstream commits, from `36668dbe4fe2f8c881cc4f93bc675413eef1406f` to `47ace94962a714a561d7cfbdbaa4c721ef6b0598`, and landed as squash `e96c74aa48e7ae5b56b70db9b7a62096dc0df0d5` with parent `af4a4ec39706fcffca53bf26b3168126bd5f6bd3`. Its intake recorded SKIP for the squash-recovery anchor because [KAT-3329 / PR #212](https://github.com/gannonh/kata-code/pull/212) had landed as a merge commit and pin `36668dbe4fe2f8c881cc4f93bc675413eef1406f` was an ancestor of the Kata base. GitHub then squash-merged #223. Every integration since #212 has landed as a squash, so each run has needed the recovery anchor for the pin before it. Check ancestry after landing, not just on the PR branch.

## Squash after SKIP of the recovery anchor

| Observed trap | Resolution to carry forward |
| --- | --- |
| Intake recorded SKIP for squash recovery because the previous pin was already an ancestor of the Kata base, then GitHub squash-merged the PR | After [KAT-3371 / PR #223](https://github.com/gannonh/kata-code/pull/223) landed as `e96c74aa48e7ae5b56b70db9b7a62096dc0df0d5`, `git merge-base --is-ancestor 47ace94962a714a561d7cfbdbaa4c721ef6b0598 HEAD` is false. [KAT-3411 / PR #239](https://github.com/gannonh/kata-code/pull/239) recovered that pin, then landed as squash `8b5a83d06198cb4dfec5da735217c09310c00796` and lost `c14f6015bfe479d313355cb234af1a5c16dbb15f` the same way. [KAT-3432 / PR #247](https://github.com/gannonh/kata-code/pull/247) recovered `c14f6015bfe479d313355cb234af1a5c16dbb15f`, then landed as squash `cc725adf0cef8a772d0b11cdfd02579c6462b8ea` and lost `b379b5b1407b4c718095cd13395173b6cc005218`. The next intake recovers the live pin from `FORK.md` when it lacks ancestry. A pre-merge ancestor check does not prove post-squash ancestry. |
