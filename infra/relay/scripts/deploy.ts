...
const deployBaseServices = Layer.mergeAll(
  ...
  TelemetryLive,
  LoggingCli,
  // beta.79 split alchemy's own prompting behind Interaction. This deploy drives its
  // confirmations through Prompt.Confirm and `--yes`, and registers no auth provider,
