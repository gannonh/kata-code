  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Kata Code prerelease is available for nightly testers."
          : "A new Kata Code latest release is available.",
...
).pipe(Command.withDescription("Post a Kata Code release announcement to Discord."));
