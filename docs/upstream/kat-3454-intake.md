...
- Take upstream's edits to the parked `mobile-eas-preview.yml` and `mobile-showcase-screenshots.yml`. Git applied them by rename to `.github/disabled/`, where they stay inactive.
