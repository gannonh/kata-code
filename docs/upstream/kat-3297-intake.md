...
- SKIP the six new Android launcher/background/splash PNGs containing T3 artwork. KEEP existing Kata variant universal launcher assets and use Kata iOS 1024 assets for the new Android splash fields; the upstream exporter only writes unused filenames. Existing monochrome artwork debt remains separate.
