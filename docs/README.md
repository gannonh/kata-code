...
- [Install Kata Code](./user/install.md)
...
- [Updating Kata Code](./user/updating.md)
...
[documentation rules](../AGENTS.md) before adding one.
...
- [Kata Code Connect](./internals/t3-connect.md)
...
- [Environment variables (1Password)](./operations/environment-variables.md)
- [Kata Code Connect setup](./operations/connect-setup.md)
