...
The Kata Code server sends product usage events to PostHog, associated with a hashed account or
...
To disable collection, set `KATACODE_TELEMETRY_ENABLED=false` in the server's environment before
