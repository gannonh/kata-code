...
also send files to Kata Code through another app's system share sheet.
...
messages survive app restarts. Signing out of Kata Code Connect keeps that work on your
...
Kata Code remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. Kata Code deletes the temporary audio after
...
Provider commands must start the message to run. Kata Code commands such as
...
complete Kata Code tells you and leaves the chip for you to remove or replace. A chip whose
