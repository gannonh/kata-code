...
Both instances must use the same **CODEX_HOME path**. Kata Code prepares the shared
...
Choose the other account from the thread's model picker. Kata Code offers compatible
