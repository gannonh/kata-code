...
When you change a new thread's project, Kata Code stays in the current environment
...
If dragging is unavailable for one environment, update the Kata Code server running in that
