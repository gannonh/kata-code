...
Kata Code connects to your Git hosting provider so you can create pull requests, review code, and manage repositories without leaving the app.
...
- Command-click (Control-click on Windows and Linux) a pull request number in the sidebar to open it in your browser instead of in Kata Code
...
If both are set, the access token wins. Restart Kata Code and verify the connection in **Source
Control settings**.
