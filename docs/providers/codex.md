...
type: Guide
title: "Codex"
description: "This guide is for people who want to use more than one Codex account in Kata Code."
...
This guide is for people who want to use more than one Codex account in Kata Code.
