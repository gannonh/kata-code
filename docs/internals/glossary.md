...
Terms whose meaning matters across Kata Code. Architecture and lifecycle constraints belong in the
...
| Kata Code home | The base data directory. Runtime state normally lives under its `userdata` directory.             |
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime Kata Code controls, such as Codex or Claude Code.                                          |
...
| Adapter             | The boundary translating a provider's native protocol into Kata Code operations and events.                  |
