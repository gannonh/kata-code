...
| [`task-workspaces/guided-task.spec.ts`](../../e2e/tests/task-workspaces/guided-task.spec.ts) | `@task-workspaces @agent` (+ `@codex`, `@claude`, `@pi`) | Full Guided flow through completed Implement, one test per provider in the registry ([`e2e/src/config/providers.ts`](../../e2e/src/config/providers.ts)) |
