---
type: Plan
title: "Version Control Phase 2: Source Control Provider Foundation"
description: "Introduce a pluggable source-control provider layer and rewrite GitHub support as an Effect-native provider. This phase should preserve the existing GitHub Commit + PR flow while making GitLab and Azu"
tags: [plan]
