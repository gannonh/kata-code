---
type: Plan
title: "Branch/Environment Picker in ChatView Input"
description: "Add a secondary toolbar below the ChatView input area (similar to Codex UI) that lets users select the target branch and environment mode (Local vs New worktree) before sending their first message."
tags: [plan]
