---
type: Plan
title: "Version Control Phase 1: VCS Driver Foundation"
description: "Introduce a provider-neutral VCS layer and rewrite the local Git implementation as an Effect-native driver. This phase should preserve user-visible behavior while replacing the Git-first service bound"
tags: [plan]
