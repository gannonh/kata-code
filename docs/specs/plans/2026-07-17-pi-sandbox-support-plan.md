...
- [x] **Step 1: Apply the temporary local gate bypass (do not commit)**
...
- [x] **Step 2: Provision a Docker sandbox**
...
- [x] **Step 3: Run the validation matrix**
...
- [x] **Step 4: Record results in the build report**
...
- [x] **Step 5: Revert the bypass and commit the evidence**
...
- [x] **Step 2: Provision a Vercel sandbox**
...
- [x] **Step 1: Hide host Pi credentials and apply the bypass**
...
- [x] **Step 2: Provision a fresh Docker sandbox and verify**
...
- [x] **Step 3: Restore credentials, record, commit**
...
- [x] **Step 2: Re-run the affected matrix rows**
...
- [x] **Step 3: Verify and commit each fix atomically**
...
- [x] **Step 1: Update the test to expect Pi un-gated**
...
- [x] **Step 3: Remove Pi from the kind set**
...
- [x] **Step 4: Run tests and full gates**
...
- [x] **Step 1: File the Cursor tooltip deferred-work issue**
...
- [x] **Step 2: Update spec status and index**
