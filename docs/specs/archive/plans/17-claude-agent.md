---
type: Plan
title: "Plan: Claude Code Integration (Orchestration Architecture)"
description: "The previous plan targeted a pre-orchestration architecture (`ProviderManager`, provider-native WS event methods, and direct provider UI wiring). The current app now routes everything through:"
tags: [plan]
