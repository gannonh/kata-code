---
type: Plan
title: "Plan: Unify Process and PTY Session Abstractions in ProcessManager"
description: "Refactor `ProcessManager` to use a single runtime-session interface for child-process and PTY modes."
tags: [plan]
