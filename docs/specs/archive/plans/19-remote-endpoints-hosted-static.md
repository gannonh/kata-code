---
type: Plan
title: "Remote Endpoints and Hosted Static App Plan"
description: "Make remote access feel first-class while keeping the free DIY path open."
tags: [plan]
...
The tunnel fabric can later be Pipenet-derived, Tailscale-derived, or another reverse tunnel implementation. The rest of Kata Code should only see an `AdvertisedEndpoint`.
