---
type: Plan
title: "Plan: Add CI Workflow for Core Quality Gates"
description: "Add GitHub Actions workflow to run lint/typecheck/test (and optionally smoke-test) on pushes and PRs."
tags: [plan]
