---
type: Plan
title: "Plan: Centralize Model Normalization in Contracts"
description: "Move model alias/default normalization into `packages/contracts` so desktop and renderer use one shared source of truth."
tags: [plan]
