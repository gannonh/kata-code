...
export const HostProcessWorkingDirectory = Context.Reference<string>(
  "@kata-sh/code-shared/hostProcess/HostProcessWorkingDirectory",
  {
...
export const HostProcessExecutablePath = Context.Reference<string>(
  "@kata-sh/code-shared/hostProcess/HostProcessExecutablePath",
  {
...
export const HostProcessArguments = Context.Reference<ReadonlyArray<string>>(
  "@kata-sh/code-shared/hostProcess/HostProcessArguments",
  {
 ...
 * `katacode` for a PATH lookup, `./katacode` or the launcher symlink for an explicit
...
export const HostProcessInvokedAs = Context.Reference<string>(
  "@kata-sh/code-shared/hostProcess/HostProcessInvokedAs",
  {
...
export const HostProcessIsExecutable = Context.Reference<boolean>(
  "@kata-sh/code-shared/hostProcess/HostProcessIsExecutable",
  {
...
export const HostProcessAddresses = Context.Reference<Effect.Effect<ReadonlySet<string>>>(
  "@kata-sh/code-shared/hostProcess/HostProcessAddresses",
  {
    defaultValue: () =>
      Effect.gen(function* () {
...
export const HostProcessUserId = Context.Reference<number | undefined>(
  "@kata-sh/code-shared/hostProcess/HostProcessUserId",
  {
