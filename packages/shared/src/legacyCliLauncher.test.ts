...
// oxlint-disable-next-line kata-code/no-global-process-runtime -- This test launches a real host executable.
const hostPlatform = NodeOS.platform();
// oxlint-disable-next-line kata-code/no-global-process-runtime -- Match the real executable used by the subprocess.
