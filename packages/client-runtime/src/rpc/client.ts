import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@kata-sh/code-contracts";
...
}>("@kata-sh/code-client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.routinesSubscribe;
...
}>("@kata-sh/code-client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
