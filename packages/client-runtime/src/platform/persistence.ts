...
>()("@kata-sh/code-client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@kata-sh/code-client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@kata-sh/code-client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@kata-sh/code-client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
