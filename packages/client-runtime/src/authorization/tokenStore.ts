...
import { RelayManagedEndpoint } from "@kata-sh/code-contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@kata-sh/code-client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@kata-sh/code-client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
