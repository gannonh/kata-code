import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@kata-sh/code-contracts";
...
>()("@kata-sh/code-client-runtime/connection/onboarding/ConnectionOnboarding") {}
