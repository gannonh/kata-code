import { EnvironmentId, type DesktopSshEnvironmentTarget } from "@kata-sh/code-contracts";
import { RelayEnvironmentConnectScope } from "@kata-sh/code-contracts/relay";
