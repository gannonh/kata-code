import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@kata-sh/code-contracts";
...
>()("@kata-sh/code-client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}
