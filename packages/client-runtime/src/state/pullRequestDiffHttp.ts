import type { PullRequestDiffInput, PullRequestDiffResult } from "@kata-sh/code-contracts";
...
>()("@kata-sh/code-client-runtime/state/pullRequestDiffHttp/PullRequestDiffLoader") {}
