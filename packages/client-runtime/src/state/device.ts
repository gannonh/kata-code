import { type DeviceToolVersions, WS_METHODS } from "@kata-sh/code-contracts";
...
export const deviceToolUpdateOwnership =
  "This environment's Kata Code server chooses device tool versions for itself and its SSH hosts. Update that server to receive newer tool versions; updating only your browser or mobile app does not update a remote server.";
