...
import { classifyMarkdownImageSource } from "@kata-sh/code-client-runtime/markdown-images";
import { resolveMediaSource } from "@kata-sh/code-client-runtime/media-source";
import { parseChangeRequestUrl } from "@kata-sh/code-shared/changeRequestUrl";
...
> = {
  ...
  create_threads: ["Create", "Creating", "Created", "Kata Code threads"],
  t3_thread_start: ["Start", "Starting", "Started", "a Kata Code thread"],
  t3_thread_list: ["List", "Listing", "Listed", "Kata Code threads"],
  t3_thread_read: ["Read", "Reading", "Read", "a Kata Code thread"],
  t3_thread_send: ["Send", "Sending", "Sent", "to a Kata Code thread"],
  t3_thread_wait: ["Wait", "Waiting", "Waited", "for a Kata Code thread"],
  t3_thread_interrupt: ["Interrupt", "Interrupting", "Interrupted", "a Kata Code thread"],
