...
const rule = createOxlintRuleHarness("kata-code/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("kata-code/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · Kata Code";`);
