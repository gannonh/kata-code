...
const legacyRule = createOxlintRuleHarness("kata-code/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("kata-code/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
